...
result={'version':'2.8.0','required_files':required,'checked_files':len(required),
        'tkinter':True,'_tkinter.pyd':True,'pyi_tk_runtime':True}
(root/'.qa/guided-280-archive.json').write_text(json.dumps(result,indent=2))
print(json.dumps(result,indent=2))

for module in ('engine.biome_catalog','engine.biome_scenes','engine.tutorial_lessons','engine.tutorial_runtime','engine.sky_layers','ui.biomes','ui.tutorial'):
